        ...
        <ion-toolbar color="warning">
            <ion-grid>
                <ion-row>
                  ...
                  <ion-col><h1>Personal Information</h1></ion-col>
                  <ion-col></ion-col>
                </ion-row>
              </ion-grid>
        </ion-toolbar>
        ...
        <ion-toolbar color="warning">
            <ion-grid>
                <ion-row>
                  ...
                  <ion-col><h1>Contact Preferences</h1></ion-col>
                  <ion-col></ion-col>
                </ion-row>
              </ion-grid>
        </ion-toolbar>
        ...
        <ion-toolbar color="warning">
            <ion-grid>
                <ion-row>
                  ...
                  <ion-col><h1>Symptoms Page</h1></ion-col>
                  <ion-col></ion-col>
                </ion-row>
              </ion-grid>
        </ion-toolbar>
    ...
    connectedCallback() {
        ...
        <ion-toolbar color="warning">
            <ion-grid>
                <ion-row>
                  <ion-col></ion-col>
                  <ion-col><h1>Results Page</h1></ion-col>
                  <ion-col></ion-col>
                </ion-row>
              </ion-grid>
        </ion-toolbar>
